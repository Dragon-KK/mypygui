...
class RenderNode(Object):
    ...
    def _set_render_information(self):
        ...
        self.render_information.height = self.layout_information.height if self.layout_information.height is not None else 0
        self.render_information.width = self.layout_information.width if self.layout_information.width is not None else 0
